            ...
            if st.session_state.get(
                ...
                try:
                    ...
                    with img_col_center:
                        ...
                        st.markdown(
                            f"""<div style="width:100%;max-width:600px;height:400px;margin:0 auto;border-radius:20px;overflow:hidden;border:1px solid rgba(34,211,238,0.25);box-shadow:0 12px 35px rgba(0,0,0,0.35);"><img src="data:image/png;base64,{st.session_state.recipe_image}" style="width:100%;height:100%;object-fit:cover;display:block;" /></div>""",
                            unsafe_allow_html=True
                        )
